...
public class VanillaFallFeature implements FallFeature, CombatFeature, RegistrableFeature {
	...
	public int getFallDamage(LivingEntity entity, double fallDistance) {
		...
		System.out.println(entity.getInstance().getBlock(entity.getPosition().sub(0.0, 1.0, 0.0)) == Block.WATER);
		System.out.println(entity.getInstance().getBlock(entity.getPosition().sub(0.0, 0.0, 0.0)) == Block.WATER);
		System.out.println(entity.getInstance().getBlock(entity.getPosition().sub(0.0, -1.0, 0.0)) == Block.WATER);
